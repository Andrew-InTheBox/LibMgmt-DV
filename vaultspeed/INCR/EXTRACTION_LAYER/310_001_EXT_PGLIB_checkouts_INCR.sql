CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_checkouts_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	( 
		SELECT 
			...
			, "TDFV_SRC"."checkout_id" AS "checkout_id"
		...
		FROM "PostgresLibrary_DFV"."VW_checkouts" "TDFV_SRC"
	...
	SELECT 
		...
		, "EXT_UNION"."checkout_id" AS "checkout_id"
