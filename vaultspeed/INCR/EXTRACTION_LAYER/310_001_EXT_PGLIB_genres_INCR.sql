CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_genres_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	TRUNCATE TABLE "PostgresLibrary_EXT"."genres"  CASCADE;

	INSERT INTO "PostgresLibrary_EXT"."genres"(
		 "LOAD_CYCLE_ID"
		,"LOAD_DATE"
		,"last_updated"
		,"__$operation"
	...
	( 
		SELECT 
			...
			, COALESCE(UPPER( "TDFV_SRC"."genre_id"::text),"MEX_SRC"."KEY_ATTRIBUTE_INTEGER") AS "genre_id_BK"
			, "TDFV_SRC"."genre_name" AS "genre_name"
		FROM "PostgresLibrary_DFV"."VW_genres" "TDFV_SRC"
	...
	( 
		SELECT 
			...
			, CURRENT_TIMESTAMP + row_number() over (PARTITION BY  "CALCULATE_BK"."genre_id_BK"  ORDER BY  "CALCULATE_BK"."last_updated")
			...
			, "CALCULATE_BK"."genre_id_BK" AS "genre_id_BK"
			, "CALCULATE_BK"."genre_name" AS "genre_name"
	...
	SELECT 
		...
		, "EXT_UNION"."genre_id_BK" AS "genre_id_BK"
		, "EXT_UNION"."genre_name" AS "genre_name"
