CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."BV_PIT_daily-snapshot_books_PIT_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- PIT_UPD
	...
	( 
		...
		FROM "LIBPG_BV"."VIEW_PIT_daily-snapshot_books_SNAPSHOTDATES" "SSDV_SRC_UPD"
	...
	( 
		SELECT 
			...
			, COALESCE(LEAD("SAT_ED_SRC_UPD1"."LOAD_DATE")OVER(PARTITION BY "SAT_ED_SRC_UPD1"."books_HKEY" ORDER BY "SAT_ED_SRC_UPD1"."LOAD_DATE")
	...
	( 
		SELECT 
			...
			, COALESCE("SAT_SRC_UPD1"."LOAD_DATE","UNSAT_SRC_UPD1"."LOAD_DATE") AS "SAT_PGLIB_books_LOAD_DATE"
	...
	( 
		SELECT 
			  "MIV_UPD"."PIT_daily-snapshot_books_HKEY" AS "PIT_daily-snapshot_books_HKEY"
			...
			, "MIV_UPD"."SAT_PGLIB_books_LOAD_DATE" AS "SAT_PGLIB_books_LOAD_DATE"
		FROM "MIV_UPD" "MIV_UPD"
		LEFT OUTER JOIN "LIBPG_BV"."PIT_daily-snapshot_books" "PIT_SRC_UPD" ON  "MIV_UPD"."PIT_daily-snapshot_books_HKEY" = "PIT_SRC_UPD"."PIT_daily-snapshot_books_HKEY" AND "MIV_UPD"."SAT_PGLIB_books_HKEY" =
			"PIT_SRC_UPD"."SAT_PGLIB_books_HKEY" AND "MIV_UPD"."SAT_PGLIB_books_LOAD_DATE" = "PIT_SRC_UPD"."SAT_PGLIB_books_LOAD_DATE"
		WHERE  "PIT_SRC_UPD"."PIT_daily-snapshot_books_HKEY" IS NULL
	)
	UPDATE "LIBPG_BV"."PIT_daily-snapshot_books" "PIT_UPD_TGT"
	SET 
		 "SAT_PGLIB_books_HKEY" =  "UPD_DATA_SRC"."SAT_PGLIB_books_HKEY"
		,"SAT_PGLIB_books_LOAD_DATE" =  "UPD_DATA_SRC"."SAT_PGLIB_books_LOAD_DATE"
	FROM  "UPD_DATA_SRC"
	WHERE "PIT_UPD_TGT"."PIT_daily-snapshot_books_HKEY" =  "UPD_DATA_SRC"."PIT_daily-snapshot_books_HKEY"
	;
END;
...
BEGIN -- PIT_TGT
	...
	( 
		...
		FROM "LIBPG_BV"."VIEW_PIT_daily-snapshot_books_SNAPSHOTDATES" "SSDV_SRC"
	...
	( 
		SELECT 
			  "MIV"."PIT_daily-snapshot_books_HKEY" AS "PIT_daily-snapshot_books_HKEY"
			...
			, "MIV"."SAT_PGLIB_books_LOAD_DATE" AS "SAT_PGLIB_books_LOAD_DATE"
		FROM "MIV" "MIV"
		LEFT OUTER JOIN "LIBPG_BV"."PIT_daily-snapshot_books" "PIT_SRC" ON  "MIV"."PIT_daily-snapshot_books_HKEY" = "PIT_SRC"."PIT_daily-snapshot_books_HKEY" AND "MIV"."SAT_PGLIB_books_HKEY" =
			"PIT_SRC"."SAT_PGLIB_books_HKEY" AND "MIV"."SAT_PGLIB_books_LOAD_DATE" = "PIT_SRC"."SAT_PGLIB_books_LOAD_DATE"
		WHERE  "PIT_SRC"."PIT_daily-snapshot_books_HKEY" IS NULL
	)
	SELECT 
		  "DATA_SRC"."PIT_daily-snapshot_books_HKEY" AS "PIT_daily-snapshot_books_HKEY"
		...
		, "DATA_SRC"."SAT_PGLIB_books_LOAD_DATE" AS "SAT_PGLIB_books_LOAD_DATE"
