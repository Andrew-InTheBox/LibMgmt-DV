CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."BV_BRIDGE_books-brdg_BRIDGE_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- BRIDGE_TGT
	...
	(
		SELECT 
			  1 AS "DUMMY"
		FROM "LIBPG_BV"."BRIDGE_books-brdg" "BRIDGE_SRC"
		WHERE  "BRIDGE_SRC"."BRIDGE_books-brdg_HKEY" = "MIV"."BRIDGE_books-brdg_HKEY"
	)
	;
END;
