CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."HUB_PGLIB_magazines_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- HUB_TGT
	...
	INSERT INTO "LIBPG_FL"."HUB_magazines"(
		 "magazines_HKEY"
		,"LOAD_DATE"
		,"LOAD_CYCLE_ID"
		,"magazine_id_BK"
	...
	( 
		SELECT 
			...
			, 0 AS "LOGPOSITION"
			, "STG_SRC1"."magazine_id_BK" AS "magazine_id_BK"
	...
	( 
		SELECT 
			...
			, "CHANGE_SET"."magazine_id_BK" AS "magazine_id_BK"
			, "CHANGE_SET"."SRC_BK" AS "SRC_BK"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."magazines_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER",
	...
	SELECT 
		...
		, "MIN_LOAD_TIME"."magazine_id_BK" AS "magazine_id_BK"
		, "MIN_LOAD_TIME"."SRC_BK" AS "SRC_BK"
	FROM "MIN_LOAD_TIME" "MIN_LOAD_TIME"
	LEFT OUTER JOIN "LIBPG_FL"."HUB_magazines" "HUB_SRC" ON  "MIN_LOAD_TIME"."magazines_HKEY" = "HUB_SRC"."magazines_HKEY"
	WHERE  "MIN_LOAD_TIME"."DUMMY" = 1 AND "HUB_SRC"."magazines_HKEY" is NULL
	;
END;
