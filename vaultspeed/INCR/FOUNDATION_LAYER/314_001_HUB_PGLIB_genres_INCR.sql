CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."HUB_PGLIB_genres_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- HUB_TGT
	...
	INSERT INTO "LIBPG_FL"."HUB_genres"(
		 "genres_HKEY"
		,"LOAD_DATE"
		,"LOAD_CYCLE_ID"
		,"genre_id_BK"
	...
	( 
		SELECT 
			...
			, 0 AS "LOGPOSITION"
			, "STG_SRC1"."genre_id_BK" AS "genre_id_BK"
			, "STG_SRC1"."SRC_BK" AS "SRC_BK"
			, 0 AS "GENERAL_ORDER"
		FROM "PostgresLibrary_STG"."genres" "STG_SRC1"
	...
	( 
		SELECT 
			...
			, "CHANGE_SET"."genre_id_BK" AS "genre_id_BK"
			, "CHANGE_SET"."SRC_BK" AS "SRC_BK"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."genres_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER","CHANGE_SET"."LOAD_DATE",
	...
	SELECT 
		...
		, "MIN_LOAD_TIME"."genre_id_BK" AS "genre_id_BK"
		, "MIN_LOAD_TIME"."SRC_BK" AS "SRC_BK"
	FROM "MIN_LOAD_TIME" "MIN_LOAD_TIME"
	LEFT OUTER JOIN "LIBPG_FL"."HUB_genres" "HUB_SRC" ON  "MIN_LOAD_TIME"."genres_HKEY" = "HUB_SRC"."genres_HKEY"
	WHERE  "MIN_LOAD_TIME"."DUMMY" = 1 AND "HUB_SRC"."genres_HKEY" is NULL
	;
END;
