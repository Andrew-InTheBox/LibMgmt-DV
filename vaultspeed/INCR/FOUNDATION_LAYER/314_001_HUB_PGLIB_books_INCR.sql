CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."HUB_PGLIB_books_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- HUB_TGT
	...
	LEFT OUTER JOIN "LIBPG_FL"."HUB_books" "HUB_SRC" ON  "MIN_LOAD_TIME"."books_HKEY" = "HUB_SRC"."books_HKEY"
	WHERE  "MIN_LOAD_TIME"."DUMMY" = 1 AND "HUB_SRC"."books_HKEY" is NULL
	;
END;
