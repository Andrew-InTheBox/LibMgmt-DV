CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LNK_PGLIB_books_genres_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LNK_TGT
	...
	INSERT INTO "LIBPG_FL"."LNK_books_genres"(
	...
	( 
		SELECT 
			  "STG_SRC1"."LNK_books_genres_HKEY" AS "LNK_books_genres_HKEY"
	...
	( 
		SELECT 
			  "CHANGE_SET"."LNK_books_genres_HKEY" AS "LNK_books_genres_HKEY"
			, "CHANGE_SET"."LOAD_DATE" AS "LOAD_DATE"
			, "CHANGE_SET"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
			, "CHANGE_SET"."genres_HKEY" AS "genres_HKEY"
			, "CHANGE_SET"."books_HKEY" AS "books_HKEY"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_books_genres_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
				"CHANGE_SET"."LOGPOSITION") AS "DUMMY"
		FROM "CHANGE_SET" "CHANGE_SET"
	)
	SELECT 
		  "MIN_LOAD_TIME"."LNK_books_genres_HKEY" AS "LNK_books_genres_HKEY"
		, "MIN_LOAD_TIME"."LOAD_DATE" AS "LOAD_DATE"
		, "MIN_LOAD_TIME"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "MIN_LOAD_TIME"."genres_HKEY" AS "genres_HKEY"
		, "MIN_LOAD_TIME"."books_HKEY" AS "books_HKEY"
	FROM "MIN_LOAD_TIME" "MIN_LOAD_TIME"
	LEFT OUTER JOIN "LIBPG_FL"."LNK_books_genres" "LNK_SRC" ON  "MIN_LOAD_TIME"."LNK_books_genres_HKEY" = "LNK_SRC"."LNK_books_genres_HKEY"
	WHERE  "LNK_SRC"."LNK_books_genres_HKEY" IS NULL AND "MIN_LOAD_TIME"."DUMMY" = 1
	;
END;
