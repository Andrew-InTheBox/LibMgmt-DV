CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LNK_PGLIB_magazines_genres_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LNK_TGT
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_magazines_genres_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
	...
	LEFT OUTER JOIN "LIBPG_FL"."LNK_magazines_genres" "LNK_SRC" ON  "MIN_LOAD_TIME"."LNK_magazines_genres_HKEY" = "LNK_SRC"."LNK_magazines_genres_HKEY"
	WHERE  "LNK_SRC"."LNK_magazines_genres_HKEY" IS NULL AND "MIN_LOAD_TIME"."DUMMY" = 1
	;
END;
