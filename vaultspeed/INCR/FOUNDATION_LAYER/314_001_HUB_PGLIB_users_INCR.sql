CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."HUB_PGLIB_users_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- HUB_TGT
	...
	INSERT INTO "LIBPG_FL"."HUB_users"(
		 "users_HKEY"
		,"LOAD_DATE"
		,"LOAD_CYCLE_ID"
		,"user_id_BK"
	...
	( 
		SELECT 
			...
			, 0 AS "LOGPOSITION"
			, "STG_SRC1"."user_id_BK" AS "user_id_BK"
			, "STG_SRC1"."SRC_BK" AS "SRC_BK"
			, 0 AS "GENERAL_ORDER"
		FROM "PostgresLibrary_STG"."users" "STG_SRC1"
	...
	( 
		SELECT 
			...
			, "CHANGE_SET"."user_id_BK" AS "user_id_BK"
			, "CHANGE_SET"."SRC_BK" AS "SRC_BK"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."users_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER","CHANGE_SET"."LOAD_DATE",
	...
	SELECT 
		...
		, "MIN_LOAD_TIME"."user_id_BK" AS "user_id_BK"
		, "MIN_LOAD_TIME"."SRC_BK" AS "SRC_BK"
	FROM "MIN_LOAD_TIME" "MIN_LOAD_TIME"
	LEFT OUTER JOIN "LIBPG_FL"."HUB_users" "HUB_SRC" ON  "MIN_LOAD_TIME"."users_HKEY" = "HUB_SRC"."users_HKEY"
	WHERE  "MIN_LOAD_TIME"."DUMMY" = 1 AND "HUB_SRC"."users_HKEY" is NULL
	;
END;
