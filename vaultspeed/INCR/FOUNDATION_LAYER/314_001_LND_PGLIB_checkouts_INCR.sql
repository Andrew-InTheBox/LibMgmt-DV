CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LND_PGLIB_checkouts_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LND_TGT
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LND_checkouts_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
	...
	LEFT OUTER JOIN "LIBPG_FL"."LND_checkouts" "LND_SRC" ON  "MIN_LOAD_TIME"."LND_checkouts_HKEY" = "LND_SRC"."LND_checkouts_HKEY"
	WHERE  "LND_SRC"."LND_checkouts_HKEY" IS NULL AND "MIN_LOAD_TIME"."DUMMY" = 1
	;
END;
