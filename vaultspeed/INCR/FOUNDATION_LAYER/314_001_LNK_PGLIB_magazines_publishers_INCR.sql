CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LNK_PGLIB_magazines_publishers_INCR"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LNK_TGT
	...
	INSERT INTO "LIBPG_FL"."LNK_magazines_publishers"(
	...
	( 
		SELECT 
			  "STG_SRC1"."LNK_magazines_publishers_HKEY" AS "LNK_magazines_publishers_HKEY"
	...
	( 
		SELECT 
			  "CHANGE_SET"."LNK_magazines_publishers_HKEY" AS "LNK_magazines_publishers_HKEY"
			, "CHANGE_SET"."LOAD_DATE" AS "LOAD_DATE"
			, "CHANGE_SET"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
			, "CHANGE_SET"."publishers_HKEY" AS "publishers_HKEY"
			, "CHANGE_SET"."magazines_HKEY" AS "magazines_HKEY"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_magazines_publishers_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
				"CHANGE_SET"."LOGPOSITION") AS "DUMMY"
		FROM "CHANGE_SET" "CHANGE_SET"
	)
	SELECT 
		  "MIN_LOAD_TIME"."LNK_magazines_publishers_HKEY" AS "LNK_magazines_publishers_HKEY"
		, "MIN_LOAD_TIME"."LOAD_DATE" AS "LOAD_DATE"
		, "MIN_LOAD_TIME"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "MIN_LOAD_TIME"."publishers_HKEY" AS "publishers_HKEY"
		, "MIN_LOAD_TIME"."magazines_HKEY" AS "magazines_HKEY"
	FROM "MIN_LOAD_TIME" "MIN_LOAD_TIME"
	LEFT OUTER JOIN "LIBPG_FL"."LNK_magazines_publishers" "LNK_SRC" ON  "MIN_LOAD_TIME"."LNK_magazines_publishers_HKEY" = "LNK_SRC"."LNK_magazines_publishers_HKEY"
	WHERE  "LNK_SRC"."LNK_magazines_publishers_HKEY" IS NULL AND "MIN_LOAD_TIME"."DUMMY" = 1
	;
END;
