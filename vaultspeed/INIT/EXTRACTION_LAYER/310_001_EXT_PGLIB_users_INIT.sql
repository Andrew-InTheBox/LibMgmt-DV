CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_users_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	( 
		...
		SELECT 
			...
			, "MEX_EXT_SRC"."ATTRIBUTE_VARCHAR"::text AS "email"
	...
	( 
		SELECT 
			...
			, COALESCE(UPPER( "PREP_EXCEP"."user_id"::text),"MEX_SRC"."KEY_ATTRIBUTE_INTEGER") AS "user_id_BK"
