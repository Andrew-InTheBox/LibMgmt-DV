CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_bookauthor_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	( 
		...
		FROM "lib_mgmt"."book_author" "INI_SRC"
	...
	( 
		SELECT 
			...
			, UPPER( "PREP_EXCEP"."author_id"::text) AS "author_id_FK_authorid_BK"
