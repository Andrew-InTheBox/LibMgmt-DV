CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_genres_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	( 
		SELECT 
			...
			, "INI_SRC"."genre_name" AS "genre_name"
		FROM "lib_mgmt"."genres" "INI_SRC"
	...
	( 
		SELECT 
			...
			, "LOAD_INIT_DATA"."genre_name" AS "genre_name"
		...
		SELECT 
			...
			, "MEX_EXT_SRC"."ATTRIBUTE_VARCHAR"::text AS "genre_name"
	...
	( 
		SELECT 
			...
			, COALESCE(UPPER( "PREP_EXCEP"."genre_id"::text),"MEX_SRC"."KEY_ATTRIBUTE_INTEGER") AS "genre_id_BK"
			, "PREP_EXCEP"."genre_name" AS "genre_name"
