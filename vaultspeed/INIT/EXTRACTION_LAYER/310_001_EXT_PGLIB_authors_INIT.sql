CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."EXT_PGLIB_authors_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- EXT_TGT
	...
	TRUNCATE TABLE "PostgresLibrary_EXT"."authors"  CASCADE;

	INSERT INTO "PostgresLibrary_EXT"."authors"(
		 "LOAD_CYCLE_ID"
		,"LOAD_DATE"
		,"last_updated"
		,"__$operation"
	...
	( 
		SELECT 
			...
			, COALESCE("INI_SRC"."author_id", CAST("MEX_INR_SRC"."KEY_ATTRIBUTE_INTEGER" AS INTEGER)) AS "author_id"
			, "INI_SRC"."first_name" AS "first_name"
			, "INI_SRC"."last_name" AS "last_name"
		FROM "lib_mgmt"."authors" "INI_SRC"
	...
	( 
		SELECT 
			...
			, "LOAD_INIT_DATA"."author_id" AS "author_id"
		...
		SELECT 
			...
			, CAST("MEX_EXT_SRC"."KEY_ATTRIBUTE_INTEGER" AS INTEGER) AS "author_id"
	...
	( 
		SELECT 
			...
			, "PREP_EXCEP"."author_id" AS "author_id"
			, COALESCE(UPPER( "PREP_EXCEP"."author_id"::text),"MEX_SRC"."KEY_ATTRIBUTE_INTEGER") AS "author_id_BK"
	...
	SELECT 
		...
		, "CALCULATE_BK"."author_id_BK" AS "author_id_BK"
