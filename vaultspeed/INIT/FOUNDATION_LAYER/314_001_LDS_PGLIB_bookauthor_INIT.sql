CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LDS_PGLIB_bookauthor_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LDS_TGT
	...
	TRUNCATE TABLE "LIBPG_FL"."LDS_PGLIB_book_author"  CASCADE;
	...
	( 
		SELECT 
			  "STG_DL_INR_SRC"."LND_book_author_HKEY" AS "LND_book_author_HKEY"
			, "STG_DL_INR_SRC"."book_id" AS "book_id"
			, "STG_DL_INR_SRC"."author_id" AS "author_id"
			...
			, ROW_NUMBER()OVER(PARTITION BY "STG_DL_INR_SRC"."LND_book_author_HKEY" ORDER BY "STG_DL_INR_SRC"."LOAD_DATE") AS "DUMMY"
		FROM "PostgresLibrary_STG"."book_author" "STG_DL_INR_SRC"
	)
	SELECT 
		  "STG_DL_SRC"."LND_book_author_HKEY" AS "LND_book_author_HKEY"
		, "STG_DL_SRC"."book_id" AS "book_id"
		, "STG_DL_SRC"."author_id" AS "author_id"
