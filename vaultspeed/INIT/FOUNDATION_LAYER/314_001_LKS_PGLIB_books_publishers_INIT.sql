CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LKS_PGLIB_books_publishers_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LKS_TGT
	...
	TRUNCATE TABLE "LIBPG_FL"."LKS_PGLIB_books_publishers"  CASCADE;
	...
	( 
		SELECT 
			  "STG_INR_SRC"."LNK_books_publishers_HKEY" AS "LNK_books_publishers_HKEY"
	...
	SELECT 
		  "STG_SRC"."LNK_books_publishers_HKEY" AS "LNK_books_publishers_HKEY"
