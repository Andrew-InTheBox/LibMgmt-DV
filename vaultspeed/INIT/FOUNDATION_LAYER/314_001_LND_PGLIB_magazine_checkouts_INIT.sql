CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LND_PGLIB_magazine_checkouts_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LND_TGT
	...
	TRUNCATE TABLE "LIBPG_FL"."LND_magazine_checkouts"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LND_magazine_checkouts_HKEY" ORDER BY "CHANGE_SET"."LOAD_CYCLE_ID",
