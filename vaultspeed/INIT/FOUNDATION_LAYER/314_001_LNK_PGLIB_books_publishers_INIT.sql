CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LNK_PGLIB_books_publishers_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LNK_TGT
	...
	TRUNCATE TABLE "LIBPG_FL"."LNK_books_publishers"  CASCADE;
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_books_publishers_HKEY" ORDER BY "CHANGE_SET"."LOAD_CYCLE_ID",
