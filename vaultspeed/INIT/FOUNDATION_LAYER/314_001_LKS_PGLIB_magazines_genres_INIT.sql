CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."LKS_PGLIB_magazines_genres_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- LKS_TGT
	...
	TRUNCATE TABLE "LIBPG_FL"."LKS_PGLIB_magazines_genres"  CASCADE;
	...
	( 
		SELECT 
			  "STG_INR_SRC"."LNK_magazines_genres_HKEY" AS "LNK_magazines_genres_HKEY"
	...
	SELECT 
		  "STG_SRC"."LNK_magazines_genres_HKEY" AS "LNK_magazines_genres_HKEY"
