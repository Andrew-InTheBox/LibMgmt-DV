CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."BV_PIT_daily-snapshot_authors_PIT_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- PIT_TGT
	...
	TRUNCATE TABLE "LIBPG_BV"."PIT_daily-snapshot_authors"  CASCADE;
	...
	INNER JOIN "LIBPG_BV"."VIEW_PIT_daily-snapshot_authors_SNAPSHOTDATES" "SNAPSHOTDATES" ON  "HUB_SRC"."LOAD_DATE" <= "SNAPSHOTDATES"."SNAPSHOT_TIMESTAMP"
