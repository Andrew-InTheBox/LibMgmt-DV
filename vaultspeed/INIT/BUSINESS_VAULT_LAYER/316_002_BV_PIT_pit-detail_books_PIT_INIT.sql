CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."BV_PIT_pit-detail_books_PIT_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- PIT_TGT
	...
	TRUNCATE TABLE "LIBPG_BV"."PIT_pit-detail_books"  CASCADE;
	...
	INNER JOIN "LIBPG_BV"."VIEW_PIT_pit-detail_books_SNAPSHOTDATES" "SNAPSHOTDATES" ON  "SNAPSHOTDATES"."books_HKEY" = "HUB_SRC"."books_HKEY"
