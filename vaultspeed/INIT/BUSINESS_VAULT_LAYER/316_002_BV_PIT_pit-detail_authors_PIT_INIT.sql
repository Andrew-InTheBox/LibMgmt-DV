CREATE OR REPLACE FUNCTION "LibraryMgmt_PROC"."BV_PIT_pit-detail_authors_PIT_INIT"() 
RETURNS void 
LANGUAGE 'plpgsql' 
...
BEGIN -- PIT_TGT
	...
	TRUNCATE TABLE "LIBPG_BV"."PIT_pit-detail_authors"  CASCADE;
	...
	INNER JOIN "LIBPG_BV"."VIEW_PIT_pit-detail_authors_SNAPSHOTDATES" "SNAPSHOTDATES" ON  "SNAPSHOTDATES"."authors_HKEY" = "HUB_SRC"."authors_HKEY"
