...
DROP VIEW IF EXISTS "LIBPG_BV"."LKS_PGLIB_magazines_genres";
CREATE  VIEW "LIBPG_BV"."LKS_PGLIB_magazines_genres"  AS 
	SELECT 
		  "DVT_SRC"."LNK_magazines_genres_HKEY" AS "LNK_magazines_genres_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."DELETE_FLAG" AS "DELETE_FLAG"
		, "DVT_SRC"."last_updated" AS "last_updated"
		, "DVT_SRC"."magazine_id" AS "magazine_id"
		, "DVT_SRC"."genre_id" AS "genre_id"
	FROM "LIBPG_FL"."LKS_PGLIB_magazines_genres" "DVT_SRC"
	;
