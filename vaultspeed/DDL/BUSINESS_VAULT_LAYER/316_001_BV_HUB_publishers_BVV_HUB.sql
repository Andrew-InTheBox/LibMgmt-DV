...
DROP VIEW IF EXISTS "LIBPG_BV"."HUB_publishers";
CREATE  VIEW "LIBPG_BV"."HUB_publishers"  AS 
	SELECT 
		  "DVT_SRC"."publishers_HKEY" AS "publishers_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."publisher_id_BK" AS "publisher_id_BK"
		, "DVT_SRC"."SRC_BK" AS "SRC_BK"
	FROM "LIBPG_FL"."HUB_publishers" "DVT_SRC"
	;
