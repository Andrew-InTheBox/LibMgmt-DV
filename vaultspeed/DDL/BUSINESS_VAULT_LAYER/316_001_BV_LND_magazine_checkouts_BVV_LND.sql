...
DROP VIEW IF EXISTS "LIBPG_BV"."LND_magazine_checkouts";
CREATE  VIEW "LIBPG_BV"."LND_magazine_checkouts"  AS 
	SELECT 
		  "DVT_SRC"."LND_magazine_checkouts_HKEY" AS "LND_magazine_checkouts_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."magazines_HKEY" AS "magazines_HKEY"
		, "DVT_SRC"."users_HKEY" AS "users_HKEY"
	FROM "LIBPG_FL"."LND_magazine_checkouts" "DVT_SRC"
	;
