...
DROP VIEW IF EXISTS "LIBPG_BV"."LKS_PGLIB_books_genres";
CREATE  VIEW "LIBPG_BV"."LKS_PGLIB_books_genres"  AS 
	SELECT 
		  "DVT_SRC"."LNK_books_genres_HKEY" AS "LNK_books_genres_HKEY"
	...
	FROM "LIBPG_FL"."LKS_PGLIB_books_genres" "DVT_SRC"
	;
