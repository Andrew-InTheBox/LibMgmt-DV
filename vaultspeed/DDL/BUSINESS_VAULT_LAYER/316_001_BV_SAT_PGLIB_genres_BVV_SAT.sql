...
DROP VIEW IF EXISTS "LIBPG_BV"."SAT_PGLIB_genres";
CREATE  VIEW "LIBPG_BV"."SAT_PGLIB_genres"  AS 
	SELECT 
		...
		, "DVT_SRC"."genre_name" AS "genre_name"
	FROM "LIBPG_FL"."SAT_PGLIB_genres" "DVT_SRC"
	;
