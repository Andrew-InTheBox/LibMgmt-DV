...
DROP VIEW IF EXISTS "LIBPG_BV"."LKS_PGLIB_books_publishers";
CREATE  VIEW "LIBPG_BV"."LKS_PGLIB_books_publishers"  AS 
	SELECT 
		  "DVT_SRC"."LNK_books_publishers_HKEY" AS "LNK_books_publishers_HKEY"
	...
	FROM "LIBPG_FL"."LKS_PGLIB_books_publishers" "DVT_SRC"
	;
