...
DROP VIEW IF EXISTS "LIBPG_BV"."SAT_PGLIB_authors";
CREATE  VIEW "LIBPG_BV"."SAT_PGLIB_authors"  AS 
	SELECT 
		...
		, "DVT_SRC"."author_id" AS "author_id"
		, "DVT_SRC"."first_name" AS "first_name"
		, "DVT_SRC"."last_name" AS "last_name"
	FROM "LIBPG_FL"."SAT_PGLIB_authors" "DVT_SRC"
	;
