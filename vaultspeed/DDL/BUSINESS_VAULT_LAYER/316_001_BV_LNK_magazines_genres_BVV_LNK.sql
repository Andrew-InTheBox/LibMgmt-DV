...
DROP VIEW IF EXISTS "LIBPG_BV"."LNK_magazines_genres";
CREATE  VIEW "LIBPG_BV"."LNK_magazines_genres"  AS 
	SELECT 
		  "DVT_SRC"."LNK_magazines_genres_HKEY" AS "LNK_magazines_genres_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."genres_HKEY" AS "genres_HKEY"
		, "DVT_SRC"."magazines_HKEY" AS "magazines_HKEY"
	FROM "LIBPG_FL"."LNK_magazines_genres" "DVT_SRC"
	;
