...
DROP VIEW IF EXISTS "LIBPG_BV"."LND_book_author";
CREATE  VIEW "LIBPG_BV"."LND_book_author"  AS 
	SELECT 
		  "DVT_SRC"."LND_book_author_HKEY" AS "LND_book_author_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."authors_HKEY" AS "authors_HKEY"
		, "DVT_SRC"."books_HKEY" AS "books_HKEY"
	FROM "LIBPG_FL"."LND_book_author" "DVT_SRC"
	;
