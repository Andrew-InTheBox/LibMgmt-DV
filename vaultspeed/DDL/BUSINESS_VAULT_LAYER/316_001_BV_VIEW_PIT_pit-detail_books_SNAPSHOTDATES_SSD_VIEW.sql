...
DROP VIEW IF EXISTS "LIBPG_BV"."VIEW_PIT_pit-detail_books_SNAPSHOTDATES";
CREATE  VIEW "LIBPG_BV"."VIEW_PIT_pit-detail_books_SNAPSHOTDATES"  AS 
	SELECT DISTINCT 
		  "SAT_SRC1"."books_HKEY" AS "books_HKEY"
		, "SAT_SRC1"."last_updated" AS "SNAPSHOT_TIMESTAMP"
	FROM "LIBPG_FL"."SAT_PGLIB_books" "SAT_SRC1"
	;
