...
DROP VIEW IF EXISTS "LIBPG_BV"."HUB_magazines";
CREATE  VIEW "LIBPG_BV"."HUB_magazines"  AS 
	SELECT 
		  "DVT_SRC"."magazines_HKEY" AS "magazines_HKEY"
		, "DVT_SRC"."LOAD_DATE" AS "LOAD_DATE"
		, "DVT_SRC"."LOAD_CYCLE_ID" AS "LOAD_CYCLE_ID"
		, "DVT_SRC"."magazine_id_BK" AS "magazine_id_BK"
		, "DVT_SRC"."SRC_BK" AS "SRC_BK"
	FROM "LIBPG_FL"."HUB_magazines" "DVT_SRC"
	;
