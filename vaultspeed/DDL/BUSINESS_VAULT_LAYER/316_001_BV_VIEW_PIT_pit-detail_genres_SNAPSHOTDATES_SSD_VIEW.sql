...
DROP VIEW IF EXISTS "LIBPG_BV"."VIEW_PIT_pit-detail_genres_SNAPSHOTDATES";
CREATE  VIEW "LIBPG_BV"."VIEW_PIT_pit-detail_genres_SNAPSHOTDATES"  AS 
	SELECT DISTINCT 
		  "SAT_SRC1"."genres_HKEY" AS "genres_HKEY"
		, "SAT_SRC1"."last_updated" AS "SNAPSHOT_TIMESTAMP"
	FROM "LIBPG_FL"."SAT_PGLIB_genres" "SAT_SRC1"
	;
