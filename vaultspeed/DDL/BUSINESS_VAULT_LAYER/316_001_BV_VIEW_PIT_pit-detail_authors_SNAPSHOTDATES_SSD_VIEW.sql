...
DROP VIEW IF EXISTS "LIBPG_BV"."VIEW_PIT_pit-detail_authors_SNAPSHOTDATES";
CREATE  VIEW "LIBPG_BV"."VIEW_PIT_pit-detail_authors_SNAPSHOTDATES"  AS 
	SELECT DISTINCT 
		  "SAT_SRC1"."authors_HKEY" AS "authors_HKEY"
		, "SAT_SRC1"."last_updated" AS "SNAPSHOT_TIMESTAMP"
	FROM "LIBPG_FL"."SAT_PGLIB_authors" "SAT_SRC1"
	;
