...
DROP VIEW IF EXISTS "PostgresLibrary_DFV"."VW_genres";
CREATE  VIEW "PostgresLibrary_DFV"."VW_genres"  AS 
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."genre_name" AS "genre_name"
		FROM "lib_mgmt"."genres" "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."genre_name" AS "genre_name"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW"."genre_name" AS "genre_name"
	...
	SELECT 
		...
		, "PREPJOINBK"."genre_name" AS "genre_name"
