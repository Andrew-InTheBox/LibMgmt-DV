...
DROP VIEW IF EXISTS "PostgresLibrary_DFV"."VW_book_author";
CREATE  VIEW "PostgresLibrary_DFV"."VW_book_author"  AS 
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."author_id" AS "author_id"
		FROM "lib_mgmt"."book_author" "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."author_id" AS "author_id"
	...
	( 
		SELECT 
			...
			, COALESCE("DELTA_VIEW"."author_id", CAST("MEX_BK_SRC"."KEY_ATTRIBUTE_INTEGER" AS INTEGER)) AS "author_id"
	...
	SELECT 
		...
		, "PREPJOINBK"."author_id" AS "author_id"
