...
DROP VIEW IF EXISTS "PostgresLibrary_DFV"."VW_magazine_checkouts";
CREATE  VIEW "PostgresLibrary_DFV"."VW_magazine_checkouts"  AS 
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."magazine_checkout_id" AS "magazine_checkout_id"
		...
		FROM "lib_mgmt"."magazine_checkouts" "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."magazine_checkout_id" AS "magazine_checkout_id"
	...
	( 
		SELECT 
			...
			, COALESCE("DELTA_VIEW"."magazine_checkout_id", CAST("MEX_BK_SRC"."KEY_ATTRIBUTE_INTEGER" AS INTEGER)) AS "magazine_checkout_id"
	...
	SELECT 
		...
		, "PREPJOINBK"."magazine_checkout_id" AS "magazine_checkout_id"
